defmodule BeingUi.Component.Nav do
  ...
  def init(scene, current_scene, opts) do
    ...
    graph =
      ...
      |> dropdown(
        {[
           {"Sensor", BeingUi.Scene.Sensor},
           {"Sensor (spec)", BeingUi.Scene.SensorSpec},
           {"Primitives", BeingUi.Scene.Primitives},
           {"Fills", BeingUi.Scene.Fills},
           {"Strokes", BeingUi.Scene.Strokes},
           {"Components", BeingUi.Scene.Components},
           {"Transforms", BeingUi.Scene.Transforms},
           {"Sprites", BeingUi.Scene.Sprites},
           {"Being", BeingUi.Scene.Being}
         ], current_scene},
        id: :nav,
        translate: {90, 10}
      )
